...
insert into excluded_word values ('would'); //
insert into excluded_word values ('could'); //
...
insert into word_group values (2 ,'stand'); //
...
insert into word_group values (9 ,'fuck'); //
insert into word_group values (9 ,'suck'); //
insert into word_group values (9 ,'dick'); //
insert into word_group values (9 ,'bloody'); //
