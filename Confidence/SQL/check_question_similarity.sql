...
FOR EACH ROW  
BEGIN
	/* comparing the similarity of the new question to all the previously posted question
		if a similarity >=1 is found then stop the insertion  and return the similar question*/
