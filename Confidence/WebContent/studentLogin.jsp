		...
		<form class="form-horizontal" method="post" action="Controller">
			<div>
				<div class="form-group">
				    ...
				    <div class="col-md-8">
				      <input type="text" class="form-control" id="aSittingId" name="aSittingId" maxLength="50" placeholder="Sitting ID" required>
				    </div>
			    </div>
			    <div class="form-group">
				    <label for="aPWD" class="col-md-4 control-label">Password:</label>
				    <div class="col-md-8">
				      <input type="password" class="form-control" id="aPWD" name="aPWD" maxLength="50" placeholder="Sitting Password" required>
				    </div>
			    </div>
			</div>
