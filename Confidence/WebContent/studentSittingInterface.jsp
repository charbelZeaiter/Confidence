...
<body>
	...
	<div class="container">
		<div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr><h2 class="intro-text text-center"><strong>Sitting "${sittingBean.name}"</strong></h2><hr>
                </div>
                ...
                <div class="col-sm-8 text-center">
					...
					<form method="post" action="Controller?aAction=postque&amp;page=studentSittingInterface">
						...
						<div class="input-group">
							<input class="form-control" type="text" id="aText" name="questionText" placeholder="Type your question here!" /> <span class="input-group-btn">
					...
					<c:if test="${ !empty submitResultString }">
						<p style="color: blue;">${submitResultString}</p>
					</c:if>
					
					<c:if test="${ !empty upvoteResultString }">
						<p style="color: blue;">${upvoteResultString}</p>
					</c:if>
				...
				<div class="modal-content">
					...
					<div class="modal-body col-md-12">
						...
						<div class="col-md-8">
							...
							<input class="form-control" type="text" id="aText" name="commentText" placeholder="Any other comments?" />
						</div>
						<div class="col-md-2"></div>
					</div>
